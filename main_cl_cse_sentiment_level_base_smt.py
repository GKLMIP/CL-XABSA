...
def main():
    ...
    if args.do_distill:
        ...
        student_model_path = f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-smt-{args.seed}/checkpoint"
    ...
    if args.do_eval:
        ...
        if 'mtl' in exp_type:
            one_tgt_lang = 'fr'
            saved_model_dir = f"outputs/{args.tfm_type}-{args.src_lang}-{one_tgt_lang}-{exp_type}-{args.seed}"
