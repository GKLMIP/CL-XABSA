...
def init_args():
    ...
    output_dir = f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-{args.exp_type}-{args.seed}"
...
def get_multi_teacher_probs(args, dataset, model_class):
    ...
    teacher_paths = [f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-teacher_{l}-{args.seed}/checkpoint" for l in teacher]
...
def main():
    ...
    if args.do_distill:
        ...
        # MTL version of distillation
            ...
            teacher_model_path = f"outputs/{args.tfm_type}-{args.src_lang}-fr-acs_mtl-{args.seed}/checkpoint"
            # teacher_model_path = args.trained_teacher_paths
            teacher_probs = get_teacher_probs(args, dataset, model_class, teacher_model_path)
        ...
        student_model_path = f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-mtl-{args.seed}/checkpoint"
    ...
    if args.do_eval:
        ...
        log_file_path = f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-{args.exp_type}-{args.seed}/log.txt"
