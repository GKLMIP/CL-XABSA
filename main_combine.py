...
def get_multi_teacher_probs(args, dataset, model_class):
    # teacher_paths = []
    teacher_paths = [
        f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-teacher_one-{args.seed}-64-sentiment/checkpoint",
        f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-teacher_two-{args.seed}-64-sentiment/checkpoint",
        f"outputs/{args.tfm_type}-{args.src_lang}-{args.tgt_lang}-teacher_three-{args.seed}-32-token/checkpoint",
    ]
